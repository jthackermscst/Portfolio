<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="jthacker2747ex2e1._Default" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">

    <div class="jumbotron">
        <h2>Comc2747 Exercise 2E : Vendor Address</h2>
        <p class="lead">SQL Transactions, SQL Param,</p>
    </div>
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <asp:Button ID="newVendorButton" runat="server" OnClick="newVendorButton_Click" Text="New Vendor" />
                    </div>
                </div>
